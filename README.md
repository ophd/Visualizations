...
<img src="Output_Figures/LifeExpectancy_2010.png" width="300px">
...
<img src="Output_Figures/LifeExpectancy_Canada_(1980_2015).png" width="450px">

<img src="Output_Figures/LifeExpectancy_France_(1960_2015).png" width="450px">

## ONS Suicide Statistics

This visualization attempts to recreate the interactive plot on the age of people dying by suicide found on the UK's [Office for National Statistics website](https://www.ons.gov.uk/peoplepopulationandcommunity/healthandsocialcare/healthandwellbeing/articles/middleagedgenerationmostlikelytodiebysuicideanddrugpoisoning/2019-08-13). This is a rich visual that shows the number of people dying by suicide for each age group and each year between 1981 and 2017. The visual uses gradients to help identify trends over time. It also allows one to hover over the data for a specific year to inspect it more closely.